    ...
    <div class="container-fluid">
      <div class="d-flex flex-column align-items-center">
        ...
        <div class="text-center">
          <p>
            PlayStation Family Mark, "PS5 logo" and "PS4 logo" are registreted
        ...
        <p>
          Copyright &#169; <span class="text-uppercase">boolean</span> All right
          Reserved
        </p>
      </div>
    </div>
...
footer {
  ...
  #social-icons {
    background-color: $color-bg-footer-icons;
  }
  #icon-cont {
    width: 50px;
    height: 50px;
